...
export default function TabsLayout() {
  ...
  return (
      ...
      screenOptions={({ route }) => {
        const iconName = (focused: boolean) => {
          switch (route.name) {
            ...
            case "orders":   return focused ? "cash"   : "cash-outline";
            case "myorders": return focused ? "time"   : "time-outline";
        ...
        return {
          ...
          tabBarIcon: ({ color, focused }) => (
            <View style={{ width: 26, height: 22, alignItems: "center", justifyContent: "center" }}>
              <Ionicons name={iconName(focused) as any} size={22} color={color} />
    ...
    >
      ...
      <Tabs.Screen name="orders" options={{ title: "Đặt hàng" }} />
