...
const translations = {
  vi: {
    ...
    addOwner: "THÊM CHỦ",
    password: "Mật khẩu",
    selectRestaurants: "Chọn nhà hàng",
    noRestaurants: "Chưa có nhà hàng",
    restaurantName: "Tên nhà hàng",
    restaurantNameEn: "Tên nhà hàng (EN)",
    slug: "Slug",
    cityId: "Mã thành phố (cityId)",
    address: "Địa chỉ",
    ...
    imageUrl: "Ảnh (URL)",
    submit: "Tạo",
    createSuccess: "Tạo nhà hàng thành công",
    createFail: "Tạo nhà hàng thất bại",
  ...
  en: {
    ...
    createFail: "Failed to create restaurant",
